package aaadatabase;//import game.Domain;
...
//import mario.game.objectContainer.*;
...
import game.spell.*;
import game.spellContainer.*;

public class DEMIURGOEJEMPLO {
    public game.demiurge.Demiurge getDemiurgoDeEjemplo(){
        game.demiurge.Demiurge demiurge = new Demiurge();
        try {
